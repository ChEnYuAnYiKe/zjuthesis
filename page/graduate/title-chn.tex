...
\begin{center}
    \zihao{4}
    \begin{tabularx}{.99\textwidth}{>{\fangsong}r >{\fangsong}X<{\centering}}
        答辩委员会主席： & \uline{\hfill 李超/研究员/浙江大学 \hfill} \\
        委员1： &  \uline{\hfill 孙轶琳/副教授/浙江大学 \hfill} \\
        委员2： &  \uline{\hfill 祁宏生/副教授/浙江大学 \hfill} \\
        委员3： &  \uline{\hfill 戴美伟/高级工程师/浙江数智交院科技股份有限公司 \hfill} \\
        委员4： &  \uline{\hfill} \\
        委员5： &  \uline{\hfill} \\
    \end{tabularx}
\end{center}
...
\begin{center}
    ...
    \begin{tabularx}{.45\textwidth}{>{\fangsong}l >{\fangsong}X<{\centering}}
        答辩日期 & \uline{\hfill 二零二六年三月 \hfill}
    \end{tabularx}
\end{center}
