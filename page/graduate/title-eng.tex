...
\begin{center}
    \zihao{4}
    \begin{tabularx}{.85\textwidth}{l X<{\centering}}
        \multicolumn{2}{l}{Examining Committee Chairperson:}        \\
        \parbox{\widthof{External reviewers:}}{~} &  \uline{\hfill Chao Li/Research Fellow/ZJU \hfill} \\
        \multicolumn{2}{l}{Examining Committee Members:}            \\
        \parbox{\widthof{External reviewers:}}{~} &  \uline{\hfill Yilin Sun/Associate Professor/ZJU \hfill} \\
        \parbox{\widthof{External reviewers:}}{~} &  \uline{\hfill Hongsheng Qi/Associate Professor/ZJU \hfill} \\
        \parbox{\widthof{External reviewers:}}{~} &  \uline{\hfill Meiwei Dai/Senior Engineer/ZJIC \hfill} \\
...
\begin{center}
    ...
    \begin{tabularx}{.6\textwidth}{l X<{\centering}}
        Date of oral defence: & \uline{\hfill March 2026 \hfill}
    \end{tabularx}
\end{center}
}