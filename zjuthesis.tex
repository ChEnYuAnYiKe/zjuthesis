...
\documentclass[
    ...
    % Thesis Info
    ClassNumber     = TP242.6,          % 按中国图书分类法，学位办网上可查
...
\titletwolines{面向GNSS拒止环境的空地}{机器人系统协同定位与规划研究}
% \titleengtwolines{Collaborative Localization and Planning for Air–Ground}{ Robotic Systems in GNSS-Denied Environments}
% \titlethreelines{毕业论文题目第一行}{毕业论文题目第二行}{毕业论文题目第三行}
\titleengthreelines{Collaborative Localization and Planning}{for Air–Ground Robotic Systems}{in GNSS-Denied Environments}
